  ...
  context "using mysql" do
    ...
    describe "#adapter" do
      ...
      it "should be a Mysql2 connection" do
        assert ActiveRecord::Base.connection.is_a? ActiveRecord::ConnectionAdapters::Mysql2Adapter
      end
  ...
  context "using postgresql" do
    ...
    describe "#adapter" do
      ...
      it "should be a PostgreSQL connection" do
        assert ActiveRecord::Base.connection.is_a? ActiveRecord::ConnectionAdapters::PostgreSQLAdapter
      end
